...
import (
	...
	_ "github.com/corentinnormand/telegraf-jellyfin/plugins/inputs/jellyfin"
...
func main() {
	...
	// create the shim_. This is what will run your plugins.
	shim_ := shim.New()
	...
	err = shim_.LoadConfig(configFile)
	if err != nil {
	...
	if err := shim_.Run(*pollInterval); err != nil {
